...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        // (make use of the above created User object)
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        //Create an object of TestRequest class and use the assignForConsultation() method of testRequestUpdateService to
        // assign the particular id to the current user
        ...
        try {
            ...
            //  throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
            User doctor=userLoggedInService.getLoggedInUser();
            TestRequest req = testRequestUpdateService.assignForConsultation(id,doctor);
            return req;
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        // Create an object of TestResult class and make use of updateConsultation() method from
        ...
        try {
            ...
            //throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
            User doctor=userLoggedInService.getLoggedInUser();
            TestRequest req = testRequestUpdateService.updateConsultation(id,testResult,doctor);
            return req;
